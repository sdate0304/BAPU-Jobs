...
/****** Object:  Job [BAPU (2) - Daily - Pre-Core Processing]    Script Date: 03/17/2021 4:05:36 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 03/17/2021 4:05:36 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Start Pre-Core Data Work Batch (Batch_Type_Key = 18)]    Script Date: 03/17/2021 4:05:37 PM ******/
...
EXEC BAPU_Logging.Batch.p_Batch_Log
    ...
    ,@batch_log_key_out OUTPUT;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [p_PDR_SSP_Insert_LastRiskUnitVersion]    Script Date: 03/17/2021 4:05:37 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'p_PDR_SSP_Insert_LastRiskUnitVersion', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [p_PDR_SSP_Insert_LastCoverageUnitVersion]    Script Date: 03/17/2021 4:05:37 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'p_PDR_SSP_Insert_LastCoverageUnitVersion', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [p_BUS_Custom_Property_Risk_Detail_Load]    Script Date: 03/17/2021 4:05:38 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'p_BUS_Custom_Property_Risk_Detail_Load', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Complete Pre-Core Data Work Batch (Batch_Type_Key = 18)]    Script Date: 03/17/2021 4:05:38 PM ******/
