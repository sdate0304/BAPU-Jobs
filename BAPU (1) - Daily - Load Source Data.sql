...
/****** Object:  Job [BAPU (1) - Daily - Load Source Data]    Script Date: 12/09/2021 5:52:57 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 12/09/2021 5:52:57 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Create Folders for Excel Files]    Script Date: 12/09/2021 5:52:57 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Create Folders for Excel Files', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Clear Historical Balancing Records]    Script Date: 12/09/2021 5:52:57 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Clear Historical Balancing Records', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Start Restore BUS Database Batch (Batch_Type_Key = 3) & Start Process_Key_300]    Script Date: 12/09/2021 5:52:57 PM ******/
...
EXEC Batch.p_Process_Log
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Run 'Restore BAPU_PolicyAdministration_WarehouseCopy_From_BapuBUSSqlProd SQL Server Agent Job]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Run ''Restore BAPU_PolicyAdministration_WarehouseCopy_From_BapuBUSSqlProd SQL Server Agent Job', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Wait for 'Restore BAPU_PolicyAdministration_WarehouseCopy_From_BapuBUSSqlProd' SQL Job to Complete]    Script Date: 12/09/2021 5:52:58 PM ******/
...
SELECT @JobStatus;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Complete Restore BUS Database Batch (Batch_Type_Key = 3) & Complete Process_Key 300]    Script Date: 12/09/2021 5:52:58 PM ******/
...
IF @batch_status_out = ''Running''
      ...
      END;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Fail Process_Key 300 (BUS Staging Restore)]    Script Date: 12/09/2021 5:52:58 PM ******/
...
-- Batch Failure is handled when the process fails', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [LDR Load]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'LDR Load', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [APS Load]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'APS Load', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Gempostage Load]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Gempostage Load', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [OWSY Policy/Item/Partner ETL]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'OWSY Policy/Item/Partner ETL', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [OWSY Partner Code Reference ETL]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'OWSY Partner Code Reference ETL', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Loss XLS Load]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Loss XLS Load', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [WC Claim Load (TPA: Sedgwick (Legacy TPA Name: York)]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'WC Claim Load (TPA: Sedgwick (Legacy TPA Name: York)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SSP PDR Load Check]    Script Date: 12/09/2021 5:52:58 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SSP PDR Policy Load (BAPU)]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'SSP PDR Policy Load (BAPU)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SSP PDR Quote (BAPU)]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'SSP PDR Quote (BAPU)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Syndicate Load]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Syndicate Load', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [BDR Load]    Script Date: 12/09/2021 5:52:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'BDR Load', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [BPM & BPMi Load]    Script Date: 12/09/2021 5:52:58 PM ******/
